 ...
 * interface.
 */
public class TempProdFragment extends Fragment {
     ...
     */
    public TempProdFragment() {
    }

    // TODO: Customize parameter initialization
    @SuppressWarnings("unused")
    public static TempProdFragment newInstance(int columnCount) {
        TempProdFragment fragment = new TempProdFragment();
