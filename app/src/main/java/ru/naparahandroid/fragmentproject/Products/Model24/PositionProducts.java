...
public class PositionProducts {
    ...
    @SerializedName("loyalty_points_price")
    @Expose
    private Integer loyaltyPointsPrice;
    ...
    public Integer getLoyaltyPointsPrice() {
        return loyaltyPointsPrice;
    }

    public void setLoyaltyPointsPrice(Integer loyaltyPointsPrice) {
        this.loyaltyPointsPrice = loyaltyPointsPrice;
    }
