...
import ru.naparahandroid.fragmentproject.SendOrderFragments.TakeOutFragment.OnListFragmentInteractionListener;
...
public class MyItemRecyclerViewAdapter2 extends RecyclerView.Adapter<MyItemRecyclerViewAdapter2.ViewHolder> {
    ...
    public ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(parent.getContext())
                .inflate(R.layout.fragment_take_out, parent, false);
