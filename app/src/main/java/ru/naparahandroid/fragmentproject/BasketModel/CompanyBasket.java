...
public class CompanyBasket {
    ...
    @Expose
    private Integer id;
    @SerializedName("presenceBaskets")
    @Expose
    private List<PresenceBasket> presenceBaskets = null;
    ...
    public List<PresenceBasket> getPresenceBaskets() {
        return presenceBaskets;
    }

    public void setPresenceBaskets(List<PresenceBasket> presenceBaskets) {
        this.presenceBaskets = presenceBaskets;
    }
