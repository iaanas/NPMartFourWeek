...
public class CompanyProfile {
    ...
    @Expose
    private Integer id;
    @SerializedName("presenceProfiles")
    @Expose
    private List<PresenceProfile> presenceProfiles;

    public CompanyProfile(String name, String logo, String description, String telegramBotUsername, Integer deliveryMinPrice, String passTemplateId, String ymapCenterLat, String ymapCenterLon, Integer ymapZoom, String googlePlayId, Integer appStoreId, Integer id, List<PresenceProfile> presenceProfiles) {
        this.name = name;
        this.logo = logo;
        ...
        this.id = id;
        this.presenceProfiles = presenceProfiles;
    }
    ...
    public List<PresenceProfile> getPresenceProfiles() {
        return presenceProfiles;
    }

    public void setPresenceProfiles(List<PresenceProfile> presenceProfiles) {
        this.presenceProfiles = presenceProfiles;
    }
