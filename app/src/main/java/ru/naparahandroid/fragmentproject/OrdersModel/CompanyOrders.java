...
public class CompanyOrders {
    ...
    @SerializedName("single_phone")
    @Expose
    private String singlePhone;
    @SerializedName("id")
    @Expose
    private Integer id;
    @SerializedName("presenceOrders")
    @Expose
    private List<PresenceOrders> presenceOrders = null;
    ...
    public List<PresenceOrders> getPresenceOrders() {
        return presenceOrders;
    }

    public void setPresenceOrders(List<PresenceOrders> presenceOrders) {
        this.presenceOrders = presenceOrders;
    }
